...
Purpose: Commodity data filtering is the program which reads the data from produce_
         data.csv and get the differnt result as per requirement.
"""
import csv
'''
...
print(f'{comNums[0][0]} were available for {int(comNums[0][1]/5)} weeks.')
...
mind1 = [i[1] for i in data if i[-1] == min1 and (i[0].lower() == 'nectarines' and i[-2].lower() == 'chicago')][0]
...
# (one source code statement)
fp1 = [i[-1] for i in data if (i[0].lower() == 'nectarines' and i[-2].lower() == 'farm' and i[1] == mind1)][0]
